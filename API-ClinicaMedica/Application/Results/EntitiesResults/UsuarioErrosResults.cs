...
public class UsuarioErrosResults
{
    ...
    public static Error UsuariosNaoEncontrado() =>
        new ("UsuariosNaoEncontrado", "Não foram encontrados Usuários na base de dados.", StatusCodes.Status404NotFound);
    ...
    public static Error ErroAoCriptografarSenha() =>
        new ("ErroAoCriptografarSenha", "Erro ao Criptografar a senha do usuário.", StatusCodes.Status400BadRequest);
}